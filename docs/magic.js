...
var view = C('view');
var initialState = {
  'description': 'shows a list of git repositories with links, gitbadges and descriptions.',
  'gdpr': {
    'allowed': [],
    'show': true
  },
...
var pages = {
  '/git-list/': function gitList(state) {
    return [h1(state.title), p(['this is the ', Link({
      to: 'https://github.com/magic-modules'
    }, '@magic-modules'), ' GitList module. ', state.description]), GitBadges('magic-modules/module-list'), h2({
      id: 'installation'
    }, 'installation'), Pre('npm install @magic-modules/module-list'), h2({
      id: 'usage'
      ...
      id: 'demo'
    }, 'demo'), p('this is what it looks like'), GitList({
      id: 'gl-magic',
      header: 'magic',
      org: 'magic',
      description: [Link({
        to: 'https://magic.github.io'
      }, '@magic'), ' static and serverless webapp generator.', ' client html/css/js size ~5kb.'],
      "class": 'custom-class',
      items: [{
        name: 'core',
        description: '@magic/core library. grundstein.'
      }]
    }), h2({
      id: 'source'
  ...
  '/git-list/404/': function gitList404() {
